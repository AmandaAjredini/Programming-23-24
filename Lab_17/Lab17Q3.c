...
Program Description: A program using structures and showcasing how they work
...
{   
    ...
    // ask user to enter various biological data and store them in relevant parts of structure using scanf
